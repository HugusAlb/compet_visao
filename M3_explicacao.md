...
`keypoints.json` gerado a partir de `video-inalacao.mp4` (o vídeo do M2) com:

```
python -m pipeline.keypoints.extract --input video-inalacao.mp4 --output keypoints.json
```
